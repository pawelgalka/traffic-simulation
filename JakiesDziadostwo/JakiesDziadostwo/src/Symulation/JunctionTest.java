...
public class JunctionTest {
    public static void main(String[] args) throws Throwable{
        ...
        Lane left1 = new Lane(15, Lane.DIRECTION.LEFT,false);
        Lane right1 = new Lane(15, Lane.DIRECTION.RIGHT,false);
        Road road1 = new Road(new ArrayList(Arrays.asList(left1)), new ArrayList(Arrays.asList(right1)));

        Lane left2 = new Lane(15, Lane.DIRECTION.LEFT,false);
        Lane right2 = new Lane(15, Lane.DIRECTION.RIGHT,false);
        Road road2 = new Road(new ArrayList(Arrays.asList(left1)), new ArrayList(Arrays.asList(right1)));

        //unctionLane jLane1 = new JunctionLane(15, Lane.DIRECTION.LEFT, src.Model.Junction.JunctionLane.TURN.NO);
        ...
        while(true){
            ...
            if(true) {
                ...
                if(rand<6)
                    ...
                    road1.getRightLanes().get(0).addVehice(tmp);
            }
